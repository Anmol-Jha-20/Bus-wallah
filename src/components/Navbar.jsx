      ...
      <div className="w-full h-full flex items-center justify-between">
        ...
        >
          ...
          <div className="flex items-center justify-center">
            <button className="md:w-fit w-full mdd:px-4 px-6 md:py-1 py-2.5 bg-primary hover:bg-transparent border border-primary hover:border-primary md:rounded-full rounded-xl text-base font-normal text-neutral-50 hover:text-primary ease-in-out duration-300">
              Sign In
            </button>
          </div>
        </div>
