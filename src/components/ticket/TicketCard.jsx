    ...
    <div className="w-full rounded-xl p-5 border-2 border-neutral-300 space-y-5">
      <div className="space-y-5 w-full border-b border-neutral-300/60 pb-4">
        ...
        <div className="space-y-5">
          {/* Bus Info */}
          <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between gap-y-3">
      ...
      <div className="w-full flex items-center justify-between">
        ...
        <Link
          ...
          className="w-fit px-5 py-1.5 bg-primary hover:bg-transparent border-2 hover:border-primary rounded-xl text-sm font-normal text-neutral-50 flex items-center justify-center gap-x-2 hover:text-primary ease-in-out duration-300"
        >
          Reserve Seat
        </Link>
      </div>
