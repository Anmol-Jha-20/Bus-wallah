...
function TopSearchCard({ routeFrom, routeTo, timeDuration, price }) {
  return (
    <div className="w-full rounded-xl p-5 border-2 border-neutral-300 space-y-10">
        ...
        <div className="space-y-0">
          ...
          <div className="w-full flex items-center justify-between gap-x-3">
            ...
            <div className="flex-1 border-dashed border border-neutral-400 relative">
              <p className="absolute w-fit px-2 h-6 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-neutral-50 rounded-full flex items-center justify-center text-sm text-neutral-500 font-normal border-dashed border border-neutral-400">
                {timeDuration}
              </p>
            </div>
      ...
      <div className="w-full flex items-center justify-between">
        ...
        <button className="w-fit px-5 py-1.5 bg-primary hover:bg-transparent border-2 hover:border-primary rounded-xl text-sm font-normal text-neutral-50 flex items-center justify-center gap-x-2 hover:text-primary ease-in-out duration-300">
          Reserve Seat
        </button>
      </div>
    </div>
