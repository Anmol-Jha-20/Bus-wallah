...
function TopLayout({ bgImg, title, className }) {
  ...
  return (
    ...
    >
      <RootLayout className="absolute top-0 left-0 w-full h-full pb-10 pt-[9ch] bg-gradient-to-b from-neutral-200/90 via-neutral-500/6 to-neutral-900/70 flex items-center justify-end flex-col gap-3">
        <motion.h1
