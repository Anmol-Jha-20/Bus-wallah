...
import busSeatData from "../../../../../constants/BusSeatData.js";
import { MdOutlineChair } from "react-icons/md";
import { RiMoneyRupeeCircleLine } from "react-icons/ri";
import { Link } from "react-router-dom";
import ErrorMessage from "../../../../../components/alertmessage/errormsg/ErrorMessage.jsx";
...
function BusSeat() {
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-10">
      {/* Seat layout */}
      <div className="md:col-span-3 w-full flex items-center justify-center shadow-sm rounded-xl p-4 border border-neutral-200">
        <div className="min-w-[400px] md:min-w-full space-y-7">
      ...
      <div className="md:col-span-2 w-full space-y-5 bg-neutral-50 rounded-xl py-4 px-6 border border-neutral-200 shadow-sm">
          ...
          <div className="space-y-0.5 w-full">
            ...
            <div className="w-full flex items-center justify-between gap-x-4">
              <h1 className="text-sm text-neutral-600 font-normal">
                Kathmandu <span className="font-medium">(06:15 pm)</span>
              </h1>

              <div className="flex-1 border-dashed border border-neutral-300" />

              <h1 className="text-sm text-neutral-600 font-normal">
                Pyuthan <span className="font-medium">(08:45 am)</span>
              </h1>
            </div>
          </div>
        </div>
